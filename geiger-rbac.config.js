...
// Entries under Settings that carry their own view permission. Kept as a list
// so the key is generated by navPermissionKey() like every other nav key
// instead of being hand-written somewhere and drifting.
const SETTINGS_SECTIONS = ["Storage Backends"];

const navPermissions = [...NAV_SECTIONS, ...CREATOR_SECTIONS, ...SETTINGS_SECTIONS].map((title) => ({
