        ...
        >
          <Field label="Workflow name" htmlFor="wf-name">
            <Input
              ...
              placeholder="e.g. Auto-tag on upload"
            />
          </Field>

          <Field label="Trigger" hint="The library action that starts this workflow.">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label="Scope">
              <Select value={draft.scope} onValueChange={set("scope")}>
                ...
                <SelectContent>
                  <SelectItem value="workspace">All Assets (workspace)</SelectItem>
...
export function AllWorkflowsScreen({ projectId: projectIdProp }) {
  ...
  return (
    <MainScreenWrapper>
      <ScreenHeader
        title="Workflows"
        description="Automate what happens when something happens — when an asset is uploaded, approved, requested, and more. Build flows of conditions and actions."
        actions={
          <Button
            className="bg-primary text-primary-foreground hover:bg-primary/90"
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border bg-surface-subtle px-6 py-16 text-sm text-text-secondary">
          <LogoLoading size={48} label="Loading workflows" />
        </div>
      ) : (
        <DataTable
          columns={columns}
              ...
              <EmptyState
                ...
                description={
                  workflows.length
                    ...
                    : "Create your first automation — e.g. tag uploads for review the moment they land in the library."
                }
                action={
                  <Button
                    className="bg-primary text-primary-foreground hover:bg-primary/90"
