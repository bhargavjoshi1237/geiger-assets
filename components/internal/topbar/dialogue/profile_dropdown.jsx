...
export function ProfileDropdown({ children }) {
  ...
  useEffect(() => {
    // Auto-pick the running session from the shared parent cookie.
    getUser().then((u) => {
      if (u) setUser(u);
    });
  }, []);
        ...
        <div className="p-1.5">
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem
              ...
              className="hover:bg-transparent focus:bg-transparent px-2.5 py-2 cursor-default"
            >
