...
export async function getProjectUsage(projectId) {
...
export async function adjustProjectRollup(projectId, deltas = {}) {
  if (!projectId || !isSupabaseConfigured()) return null;
  try {
    const sb = assetsClient();
...
export async function recomputeProjectUsage(projectId) {
  if (!projectId || !isSupabaseConfigured()) return null;
  try {
    const sb = assetsClient();
