...
// Field descriptors for the settings UI live in ./fields.js, which carries no
// server-only guard so the settings screen can import the catalog in the
// browser and render the "add a backend" form from it. Re-exported here because
// this is where the rest of the backend vocabulary lives.
export { BACKEND_FIELDS } from "./fields.js";
